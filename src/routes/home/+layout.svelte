<script lang="ts">
  import { Palette, Tag, FileText, Settings } from '@lucide/svelte';
  ...
  <div class="drawer-side is-drawer-close:overflow-visible">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
      <ul class="menu w-full grow">
        {#each telas as { url, label, Icon }}
          <li>
            <a href="{"home/" + url}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip={label}>
              <Icon size="16"/>
